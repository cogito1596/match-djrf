...
from .serializers import MatchSerializer, OverSerializer, BallSerializer
...
class MatchViewSet(ModelViewSet):
    ...
    def add_ball(self, request, pk=None):
        ...
        if ball_serializer.is_valid():
            ...
            match.save()
            return Response({"message": "Ball added successfully", "data": ball_serializer.data})
    ...
    def end_over(self, request, pk=None):
        ...
        match.save()
        return Response({"message": "Over ended successfully", "overs_completed": match.overs_completed})
